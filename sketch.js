...
function preload() {
  ...
  refimg=loadImage("Mark.png");
  Jumpimg=loadImage("J.png");
  Restartimg=loadImage("Restrat1.png");
  ...
  if (gameState === PLAY) {
    ...
    if (frameCount >= 490) {
     ...
     //Soundloop=false;
      ...
      Snew=createSprite(430,25);
      Snew.addImage(Shootimg);
      Snew.scale=0.4;

      //Mark=createSprite(1200,80);
      //Mark.addImage(refimg);
      //Mark.scale=0.4;

      Jump=createSprite(1200,25);
     ...
     //   newSoldierimg.depth=secretBunker.depth+1;
      ...
      //  missile.depth = secretBunkerimg + 1;
        ...
        //  destroyedscene.depth=missile.depth+1;
         ...
         gameWon.depth=Snew.depth;
         gameWon.depth=Snew.depth+1;

         Restart=createSprite(700,30);
       ...
       //  enemiesGroup.destroyEach();
        // BulletGroup.destroyEach();
          ...
          newBatman.scale=0.3;
          newBatman.lifetime=200;
          
          ending1=createSprite(750,290,200,100);
          ...
          //Jump.depth=gameWon.depth;
         // Jump.depth=gameWon.depth-1;
         // Mark.destroy();
         // Snew.destroy();
          }
